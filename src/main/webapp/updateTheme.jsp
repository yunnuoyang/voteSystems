...
<form id="themeModel" class="layui-form" action="">
    <input name="id" value="${curTheme.id}" style="display:none">
    <div class="layui-form-item">
        <label class="layui-form-label">主题名称</label>
        <div class="layui-input-block">
            <input type="text" name="themeName" lay-verify="title" autocomplete="off" placeholder=" ${curTheme.themeName}"
                   class="layui-input">
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(demo1)', function (data) {
            console.log("1111111")
            alert("ergr")
            $.post("modify", $("#themeModel").serialize(),
                function (data) {
