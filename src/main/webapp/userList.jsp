...
<table class="layui-table" lay-data="{width: 892, height:330, url:'/user/userList', page:true, id:'idTest'}" lay-filter="demo">
    <thead>
    <tr>
        <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
        <th lay-data="{field:'id', width:120, sort: true, fixed: true}">ID</th>
        <th lay-data="{field:'loginName', width:120}">登录名</th>
        <th lay-data="{field:'realName', width:120}">姓名</th>
        <th lay-data="{field:'sex',width:120, sort: true}">性别</th>
        <th lay-data="{field:'password',width:120}">密码</th>
        <th lay-data="{field:'sex',width:120}">性别</th>
        <th lay-data="{field:'address',width:120}">地址</th>
        <th lay-data="{field:'status',width:120}">用户类型</th>
